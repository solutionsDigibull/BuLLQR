    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
          ...
          <p className="text-xs text-gray-500 mt-1">Unique Assemblies Today</p>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
          <p className="text-3xl font-bold text-gray-800">{dashboard.quality_stats.total_scans}</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
          ...
          <p className="text-xs text-gray-500 mt-1">Overall OK Rate</p>
        </div>
      </div>

      {/* Row 2: Production progress + Quality stats */}
