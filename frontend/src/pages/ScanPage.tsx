  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-gray-800">Scan</h2>
        <div className="flex items-center gap-4 text-sm">
          <span className="text-gray-500">
            Operator: <strong className="text-gray-800">{user?.full_name}</strong>
          </span>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            <label htmlFor="quality-status-select" className="block text-sm font-medium text-gray-700 mb-1">
              Quality Status
            </label>
            <select
