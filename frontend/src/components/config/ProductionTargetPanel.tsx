...
export default function ProductionTargetPanel() {
  ...
  return (
    <div className="space-y-4">
      ...
      <h3 className="text-base font-medium text-gray-700">Daily Production Target</h3>
      ...
      <form onSubmit={handleSetTarget} className="bg-gray-50 border rounded-md p-4 space-y-3">
