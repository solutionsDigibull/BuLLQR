          ...
          <tbody className="divide-y divide-gray-100">
            {products.map((product) => (
              <tr key={product.id} className="hover:bg-gray-50">
                <td className="px-4 py-3 font-medium text-gray-700">{product.product_code}</td>
                <td className="px-4 py-3 text-gray-600">{product.product_name}</td>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                {stagesLoading ? (
                  ...
                  <div className="border border-gray-200 rounded-md p-3 space-y-2 max-h-64 overflow-y-auto bg-gray-50">
                        ...
                        <div key={stage.id} className="flex items-center gap-2 text-sm">
                          ...
                          {isChecked ? (
                            <input
                              ...
                              className="w-12 border border-gray-300 rounded px-1.5 py-0.5 text-xs font-mono text-center focus:outline-none focus:ring-1 focus:ring-primary"
                            />
                          ) : (
