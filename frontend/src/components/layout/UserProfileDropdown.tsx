      ...
      {open && (
        ...
        >
          <div className="px-4 py-3 border-b border-gray-100">
            ...
            <p className="text-xs text-gray-500 capitalize mt-0.5">{roleLabel}</p>
            {user.station_id && (
          ...
          <button
            ...
            className="w-full text-left px-4 py-2.5 text-sm text-gray-600 hover:bg-gray-50 hover:text-danger transition-colors cursor-pointer"
          >
            Sign out
          </button>
        </div>
