    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          autoComplete="off"
          className={`w-full px-4 py-3 text-lg font-mono border rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed ${
            error || isInvalid ? 'border-danger' : 'border-gray-300'
          }`}
        />
        {trimmed.length > 0 && (
