...
export default function ExportPanel() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
      <h3 className="text-base font-medium text-gray-700 mb-4">Export Reports</h3>

      <div className="flex flex-wrap items-end gap-4 mb-4">
        <div>
          <label htmlFor="export-start" className="block text-xs font-medium text-gray-500 mb-1">
            Start Date
          </label>
          <input
            id="export-start"
        ...
        <div>
          <label htmlFor="export-end" className="block text-xs font-medium text-gray-500 mb-1">
            End Date
          </label>
          <input
            id="export-end"
