...
export default function QualityStatsChart({ stats }: QualityStatsChartProps) {
  if (stats.total_scans === 0) {
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
        <h3 className="text-base font-medium text-gray-700 mb-4">Quality Statistics</h3>
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
      <h3 className="text-base font-medium text-gray-700 mb-2">Quality Statistics</h3>
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500">OK ({stats.ok_count})</p>
            </div>
            <div>
              <p className="text-lg font-semibold text-red-600">
                {stats.not_ok_percentage.toFixed(1)}%
              </p>
              <p className="text-xs text-gray-500">NOT OK ({stats.not_ok_count})</p>
            </div>
          </div>
        </div>
      </div>
